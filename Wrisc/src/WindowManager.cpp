...
namespace UI
{
	...
	WindowManager::WindowManager() : mainWindow{ SCR_WIDTH, SCR_HEIGHT }
	{
		IMGUI_CHECKVERSION();
		ImGui::CreateContext();
	...
	void WindowManager::AddWindow(std::unique_ptr<UIWindow> newWindow)
	{
	...
	void WindowManager::showDockSpace(bool* p_open)
	{
